...
The model doesn't know your reach. It cannot: the number lives in your analytics, and if you did not tell it, whatever it produces is a plausible-looking fabrication. Same for effort, which depends on your codebase, your team, and what else is in flight.
...
That's the division Tarazu is built around, and it's a deliberate constraint rather than a limitation waiting to be lifted. The AI drafts. A person decides. The interesting part was never the arithmetic.

---

*[How it works](/how-it-works) covers where the AI sits in the loop, including which model does what and what it's given as context.*
