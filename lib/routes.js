...
export const ROUTES = [
  ...
  },
  {
    ...
    title: "Tarazu vs. prioritizing in a spreadsheet",
    description:
      "What spreadsheet prioritization costs, a capability comparison across four tool categories, and when a spreadsheet is still the right answer.",
    socialDescription:
      "What spreadsheet prioritization costs you — and when a spreadsheet is genuinely still the right answer.",
    lastModified: "2026-08-11",
    changeFrequency: "monthly",
    priority: 0.8,
    nav: { group: "Learn", label: "vs. spreadsheets", order: 2 },
    schemaType: "WebPage",
    llmsSection: "Guides",
  },
  {
    ...
    description:
      "Direct answers about Tarazu: what it costs, whether you need an account, which AI models it uses, where your data lives, and how RICE scoring works here.",
    lastModified: "2026-08-11",
    changeFrequency: "monthly",
    priority: 0.7,
    nav: { group: "Learn", label: "FAQ", order: 3 },
    schemaType: "FAQPage",
    llmsSection: "Reference",
  },
  {
    path: "/pricing",
    title: "Pricing",
    description:
      "Tarazu is free today, with no card and no account required. Here is exactly what that includes, and what the planned paid tiers would add.",
    lastModified: "2026-08-11",
    changeFrequency: "monthly",
    priority: 0.8,
    nav: { group: "Product", label: "Pricing", order: 2 },
    schemaType: "WebPage",
    llmsSection: "Product",
  },
  {
    path: "/blog",
    title: "Notes on product decisions",
    description:
      "Writing on prioritization, estimation, and decision records — the parts of choosing what to build that frameworks alone do not cover.",
    lastModified: "2026-08-12",
    changeFrequency: "weekly",
    priority: 0.7,
    nav: { group: "Learn", label: "Blog", order: 4 },
    schemaType: "WebPage",
    llmsSection: "Guides",
  },
  {
    ...
    title: "About Tarazu",
    description:
      "Why Tarazu exists, who built it, and the conviction behind it: prioritization deserves a purpose-built system rather than another spreadsheet.",
    lastModified: "2026-08-11",
    changeFrequency: "yearly",
    priority: 0.5,
    nav: { group: "More", label: "About", order: 1 },
