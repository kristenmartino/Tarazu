...
// Desktop guest-mode happy path: boot → navigate → load samples → toggle
// map/list → run the AI advisor and confirm the demo fallback renders
// (no ANTHROPIC_API_KEY in this environment).
test("guest can boot, load samples, toggle views, and get a demo recommendation", async ({ page }) => {
  await page.goto("/app");
  ...
  // Map/List toggle reflects the active view.
